...
(html/deftemplate login-template "views/login.html" [title]
   [:title] (html/content title))

(html/defsnippet menu-snippet "views/menu.html" [[:#menu]] [ingrCategories]
...
(html/defsnippet search-snippet "views/searchView.html" [[:#results]]  [title recipes]
...
(html/defsnippet recommedation-snippet "views/recommendationlist.html" [[:#recommendation]] 
  [recommendations]
